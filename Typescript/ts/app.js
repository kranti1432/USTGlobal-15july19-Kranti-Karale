...
var myName = "kranti"; //type string
// myName=23;                           // cant reassign 
var company; // type any
company = 'ust global';
...
console.log(sample);
//---------------------------------------array--------------
var myArray = [1345, 'keja', 'awhajd', true]; // it takes type as any so no error
console.log(myArray); //if we gives string numbrs boolean
//--------------------------------------------tuple---------------------
var myTuple = ['kk', 56, true]; // we should take all datatypes maintained in same order
//-----------------------------enum--------------------
var colors;
(function (colors) {
